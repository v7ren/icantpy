...
object IcantpySettingsStore {
    ...
    fun load(): TimerSettings {
        ...
        return try {
            ...
            TimerSettings(
                ...
                dungeonHud = bool(obj, "dungeonHud", defaults.dungeonHud),
                carryHud = bool(obj, "carryHud", defaults.carryHud),
                ...
                dungeonX = int(obj, "dungeonX", defaults.dungeonX),
                dungeonY = int(obj, "dungeonY", defaults.dungeonY),
                carryX = int(obj, "carryX", defaults.carryX),
                carryY = int(obj, "carryY", defaults.carryY),
                ...
                dropUltimate = if (obj.has("dropUltimate") && obj.get("dropUltimate").isJsonObject) {
                    DropUltimateSettings.fromJson(obj.getAsJsonObject("dropUltimate"))
                } else {
                    defaults.dropUltimate
                },
                slayer = if (obj.has("slayer") && obj.get("slayer").isJsonObject) {
                    SlayerCarrySettings.fromJson(obj.getAsJsonObject("slayer"))
                } else {
                    defaults.slayer
                },
            )
    ...
    fun save(settings: TimerSettings) {
        ...
        try {
            ...
            obj.addProperty("dungeonHud", settings.dungeonHud)
            obj.addProperty("carryHud", settings.carryHud)
            ...
            obj.addProperty("dungeonX", settings.dungeonX)
            obj.addProperty("dungeonY", settings.dungeonY)
            obj.addProperty("carryX", settings.carryX)
            obj.addProperty("carryY", settings.carryY)
            ...
            obj.add("dropUltimate", settings.dropUltimate.toJson())
            obj.add("slayer", settings.slayer.toJson())
