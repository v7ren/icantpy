...
data class TimerSettings(
    ...
    val dungeonHud: Boolean = true,
    val carryHud: Boolean = false,
    val necronX: Int = 8,
    val necronY: Int = 8,
    val goldorX: Int = 8,
    val goldorY: Int = 22,
    ...
    val dropUltimate: DropUltimateSettings = DropUltimateSettings(),
    val slayer: SlayerCarrySettings = SlayerCarrySettings(),
) {
    fun enabled(hud: TimerHud): Boolean = when (hud) {
        ...
        TimerHud.DUNGEON -> dungeonHud
        TimerHud.CARRY -> carryHud
    ...
    fun position(hud: TimerHud): Pair<Int, Int> = when (hud) {
        ...
        TimerHud.DUNGEON -> dungeonX to dungeonY
        TimerHud.CARRY -> carryX to carryY
    ...
    fun toggle(key: String): TimerSettings = when (key) {
        ...
        "dungeonHud" -> copy(dungeonHud = !dungeonHud)
        "carryHud" -> copy(carryHud = !carryHud)
    ...
    fun withHudPosition(hud: TimerHud, x: Int, y: Int): TimerSettings = when (hud) {
        ...
        TimerHud.DUNGEON -> copy(dungeonX = x, dungeonY = y)
        TimerHud.CARRY -> copy(carryX = x, carryY = y)
