...
data class ItemCustomizeState(
    ...
    fun toItemData(existing: CustomRenameItemData? = null): CustomRenameItemData {
        ...
        val created = CustomRenameItemData(
        ...
        return existing.copy(
            ...
            customNamePrefix = created.customNamePrefix,
            overrideEnchantGlint = created.overrideEnchantGlint,
            enchantGlintValue = created.enchantGlintValue,
            customGlintColor = created.customGlintColor,
            customLeatherColor = if (baseline.leatherArmor) created.customLeatherColor else existing.customLeatherColor,
            customTooltip = created.customTooltip,
        )
    }
